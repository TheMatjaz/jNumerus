 ...
 */
/**
 * This package contains the core classes and method ofjNumerus that allow
 ...
 * <p>
 * <ul>
 * <li>{@link it.matjaz.jnumerus.RomanNumeral RomanNumeral} is the representation
 ...
 * roman numeral.</li>
 * <li>{@link it.matjaz.jnumerus.RomanInteger RomanInteger} holds a
 * {@link it.matjaz.jnumerus.RomanNumeral RomanNumeral} and its
 ...
 * {@link it.matjaz.jnumerus.RomanConverter RomanConverter}, which is based on a
 * reference of roman characters generated by
 * {@link it.matjaz.jnumerus.RomanCharMapFactory RomanCharMapFactory}. Probably
 * this is one of the most useful classes, since it takes care of the
 * conversions.</li>
 * <li>{@link it.matjaz.jnumerus.RomanConverter RomanConverter} is an object
 ...
 * <li>{@link it.matjaz.jnumerus.RomanCharMapFactory RomanCharMapFactory}
 * generates a reference for
 * {@link it.matjaz.jnumerus.RomanConverter RomanConverter} to be able to convert
